...
# --- Configuration ---
source_folder = "/home/giiker/Documents/Personal/Personal/git/notes/Hacking/CTFs/HackTheBox/Linux/Medium"
...
for md_file in os.listdir(source_folder):
    if md_file.endswith(".md"):
        ...
        front_matter = f"""---
layout: post
title: "HTB Linux Medium: {title}"
description: "{title} is a Medium rated Linux machine on HTB."
categories: [CTF,HTB]
tags: [Linux,Easy]
author: g
---
